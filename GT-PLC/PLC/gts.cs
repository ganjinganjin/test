...
namespace PLC
{
	...
	[DllImport("gts.dll")]
        public static extern short GT_SetCrdFollowLoop(short cardNum,short crd,ulong loop);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowLoop(short cardNum,short crd,out ulong pLoop);
	[DllImport("gts.dll")]
